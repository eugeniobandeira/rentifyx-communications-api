...
- **Location**: `02-src/01-Api/RentifyxCommunications.Api/Messaging/IKafkaProducerFactory.cs`, `KafkaProducerFactory.cs` — the `Api/Consumers/` folder is renamed to `Api/Messaging/` as part of this feature (confirmed with the user 2026-07-14), since it now holds both consumer and producer factories, not just consumers
